...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete }) => {
  ...
  return (
    <div className="prompt_card">
      ...
      <p className="my-4 font-satoshi text-sm text-gray-700 dark:text-gray-300">{post.prompt}</p>
      ...
      {session?.user.id === post.creator._id && pathName === '/profile' && (
        <div className="mt-5 flex-center gap-4 border-t border-gray-100 dark:border-gray-700 pt-3">
